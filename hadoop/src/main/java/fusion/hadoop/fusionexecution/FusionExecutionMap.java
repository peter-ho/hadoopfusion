...
public class FusionExecutionMap<KEYIN, VALUEIN, KEYOUT, VALUEOUT> extends
		Mapper<KEYIN, VALUEIN, KEYOUT, VALUEOUT> {
	protected Mapper<KEYIN, VALUEIN, KEYOUT, VALUEOUT> m_inputMapper;
	protected Context m_context;
	
	class KeyFusionKeyContext extends Context {
		protected Context m_ctxt;
		protected HashMap<KEYOUT, KEYOUT> m_fkm;
		
		public KeyFusionKeyContext(Context ctxt, HashMap<KEYOUT, KEYOUT> fusionKeyMap) {
			m_ctxt = ctxt;
			m_fkm = fusionKeyMap;
		}
	...
	public void run(Context context)
		...
		/// get fusion key map from distributed cache
		HashMap<KEYOUT, KEYOUT> fusionKeyMap = new HashMap<KEYOUT, KEYOUT>();
		KeyFusionKeyContext kfkc = new KeyFusionKeyContext(context, fusionKeyMap);
		m_inputMapper.run(kfkc);
	}
